...
public class SM_MultipleChoice : StateMachineBehaviour
{
    [SerializeField]
    ...
    {
        Core.Instance._questionManager.EnableTriggerAreas(QuestionManager.QuestionState.MultipleChoice);
        Core.Instance._questionManager.EnableCGFAreas(QuestionManager.QuestionState.MultipleChoice);

        Core.Instance._questionManager._voteState = QuestionManager.VoteState.Waiting;

        //UI
        Core.Instance._questionManager.MultipleChoiceUI.GetComponent<Animator>().SetTrigger("Enable");
    }
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            Core.Instance._questionManager.MultipleChoiceUI.GetComponent<Animator>().SetTrigger("Exit");
