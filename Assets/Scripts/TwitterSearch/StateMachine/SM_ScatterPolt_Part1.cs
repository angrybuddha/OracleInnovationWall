...
public class SM_ScatterPolt_Part1 : StateMachineBehaviour 
{
    [SerializeField]
    ...
    {
        Core.Instance._questionManager.EnableTriggerAreas(QuestionManager.QuestionState.ScatterPlot);
        Core.Instance._questionManager.EnableCGFAreas(QuestionManager.QuestionState.ScatterPlot);
